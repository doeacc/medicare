			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="supplier-view.php">Manage Suppliers</a></li>
					</ul>
					<div class="d-flex">
			...
			<div class="row justify-content-center">
				<div class="col-12 col-md-8 col-lg-6">
					<div class="card shadow-sm">
						<div class="card-body">
							<h3 class="card-title text-center mb-4">Add Supplier</h3>
							...
							<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
								<div class="row g-3">
									...
									<div class="col-12 col-md-6">
										<label for="sname" class="form-label">Company Name</label>
										<input type="text" class="form-control" name="sname" id="sname">
									</div>
									<div class="col-12">
										<label for="sadd" class="form-label">Address</label>
										<input type="text" class="form-control" name="sadd" id="sadd">
									</div>
									<div class="col-12 col-md-6">
										<label for="sphno" class="form-label">Phone Number</label>
										<input type="number" class="form-control" name="sphno" id="sphno">
									</div>
									<div class="col-12 col-md-6">
										<label for="smail" class="form-label">Email Address</label>
										<input type="email" class="form-control" name="smail" id="smail">
									</div>
